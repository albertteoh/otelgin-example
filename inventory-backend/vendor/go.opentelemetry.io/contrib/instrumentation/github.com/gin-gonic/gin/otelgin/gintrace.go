...
func Middleware(service string, opts ...Option) gin.HandlerFunc {
	...
	return func(c *gin.Context) {
		...
		receivedSpan := oteltrace.SpanFromContext(ctx)
		receivedSpanCtx := receivedSpan.SpanContext()
		fmt.Printf("DEBUG: received traceid=%s, spanid=%s\n", receivedSpanCtx.TraceID().String(), receivedSpanCtx.SpanID())
